...
class Database
{
     ...
     * @return array $class[] - array of objects.
     */
    ...
    /**
     * The UPDATE method updates data in the database
     * if a query_select query is given, it is first checked whether
    ...
    /**
     * The DELETE method deletes all data from the database for the specified query
     * @param $query
