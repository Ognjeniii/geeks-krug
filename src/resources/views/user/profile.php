...
<head>
    ...
    <title><?php echo $full_name; ?> - GeeksKrug Profile</title>
...
<body data-bs-theme="dark">
    ...
    <div class="container mt-4">
        <div class="row">
            <?php for ($i = 1; $i <= 9; $i++) : ?>
                <?php $randomSeed = rand(1, 1000); ?>
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="card">
                        <img src="https://picsum.photos/300/300?random=<?php echo $randomSeed; ?>" class="card-img-top" alt="Post Image">
                        <div class="card-body">
                            <h5 class="card-title">Blog Post Title <?php echo $i; ?></h5>
                            <p class="card-text">
