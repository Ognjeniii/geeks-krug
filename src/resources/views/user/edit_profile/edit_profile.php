...
$user_id = $_COOKIE['user_token'] ?? $_SESSION['user_id'];
...
<div
    ...
    <div class="background-profile-div"
        ...
        <iframe src="/resources/views/user/edit_profile/profile_picture.php"
            ...
            <div class="container bg-body-tertiary p-4 rounded-2 shadow-sm">
                <nav class="navbar">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link active nav-left-link" aria-current="page" href="#"
                               data-section="basic_info">Basic
                                Info</a>
                        </li>
                        <li class="nav-item">
