...
<body data-bs-theme="dark">
    ...
    <div class="container bg-dark-subtle p-4 rounded-2 shadow-sm" style="margin-top: -37px;">
        ...
        <form action="#" method="post">
            <div class="mb-3 d-flex justify-content-between align-items-center" id="email-row">
                <div class="d-flex align-items-center gap-2">
                    <label for="email" class="form-label mb-0">Email:</label>
                    <input type="email" class="form-control" name="email" placeholder="<?php echo $user->getEmail(); ?>" disabled>
                </div>
                <div>
                    <button type="button" class="edit-button btn btn-primary" data-row-id="email-row">Edit</button>
                    <button type="submit" class="save-button btn btn-success" style="display: none;">Save</button>
                </div>
            </div>
        </form>
        ...
        <form action="#" method="post">
            <div class="mb-3 d-flex justify-content-between align-items-center" id="programminglanguages-row">
                ...
                <div>
                    <button type="button" class="edit-button btn btn-primary" data-row-id="programminglanguages-row">Edit</button>
                    <button type="submit" class="save-button btn btn-success" style="display: none;">Save</button>
                </div>
            </div>
        </form>
