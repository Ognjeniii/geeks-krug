...
<div class="container">
    ...
    <form action="../../../User/logic/edit_profile/experience_info/add_work_experience.php" method="post">
        <h4>Experience</h4>
        <div>
    ...
    <form action="../../../User/logic/edit_profile/experience_info/add_education.php" method="post">
        <div>
    ...
    <form action="../../../User/logic/edit_profile/skills_info/add_programming_language.php" method="post">
